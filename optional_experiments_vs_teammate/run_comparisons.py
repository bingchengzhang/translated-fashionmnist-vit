...
from .configurations import configuration_ids_for_groups
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--output-dir",
        default="optional_experiments_vs_teammate/results",
    )
...
def main() -> None:
    ...
    generate_visualizations(
        ...
        baseline_csv=package_dir / "teammate_baseline.csv",
        assets_dir=package_dir / "assets",
        summary_markdown=package_dir / "RESULTS.md",
    )
    print(f"Results: {results_csv.resolve()}")
    print(f"Figures: {(package_dir / 'assets').resolve()}")
